                                    ...
                                    <form class="filterForm" action="{{route('post.index')}}" method="get">
                                        ...
                                        <div class="input-group">
                                            <div class="form-outline">
                                                <input name="informations" type="search" id="title" placeholder="title"
                                                       class="form-control"/>
                                                <input name="key" type="search" id="key" placeholder="key"
                                                       class="form-control"/>
                                            </div>
                                    ...
                                    <script>
                                        $(document).on('click', '#search', function () {
                                            ...
                                            if (atr) {
                                                ...
                                                // history.pushState(null, null, '?'+el+'=' + atr);
