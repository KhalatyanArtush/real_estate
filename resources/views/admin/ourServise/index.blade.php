            ...
            <div class="container-fluid">
                <div class="container" style="column-count: 2;">
                    ...
                    <button  class="btn btn-primary" style="width: 135px;" >
                        <a id="back-from-page" href="{{ route('admin.ourServise.creat') }}" >{{__('buttons.Sign')}}</a>
                    </button>
                </div>
                <div>
                ...
                @foreach($ourServises as $ourServise)
                                    ...
                                    <div class="adminPosts">
                                        <a data-v-767ef7eb="" tabindex="0" href="{{ route('admin.ourServise.show',$ourServise->id) }}"
                                           class="Results-card">

                                            <ul class="list-group list-group-horizontal-sm">

                                                <li class="list-group-item big-li">{{  $ourServise->title }}</li>
