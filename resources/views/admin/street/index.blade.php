            ...
            <div class="container-fluid">
                <div class="container" style="column-count: 2;">
                    ...
                    <button class="btn btn-primary" style="width: 135px;">
                        <a id="back-from-page" href="{{ route('admin.street.creat') }}"> Ստեղծել նորը</a>
                    </button>
                </div>
                ...
                @foreach($streets as $street)
                        ...
                        <div class="adminPosts">
                            <a data-v-767ef7eb="" tabindex="0" href="{{ route('admin.street.show',$street->id) }}"
                               class="Results-card">

                                <ul class="list-group list-group-horizontal-sm">

                                    <li class="list-group-item big-li">{{  $street->title }}</li>
