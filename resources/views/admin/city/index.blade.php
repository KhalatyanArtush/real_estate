            ...
            <div class="container-fluid">
                <div class="container" style="column-count: 2;">
                    ...
                    <button  class="btn btn-primary" style="width: 135px;" >
                        <a id="back-from-page" href="{{ route('admin.city.creat') }}" > Ստեղծել նորը</a>
                    </button>
                </div>
                ...
                @foreach($citys as $city)
                                    ...
                                    <div class="adminPosts">
                                        <a data-v-767ef7eb="" tabindex="0" href="{{ route('admin.city.show',$city->id) }}"
                                           class="Results-card">

                                            <ul class="list-group list-group-horizontal-sm">

                                                <li class="list-group-item big-li">{{  $city->title }}</li>
