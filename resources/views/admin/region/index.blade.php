            ...
            <div class="container-fluid">
                <div class="container" style="column-count: 2;">
                    ...
                    <button  class="btn btn-primary" style="width: 135px;" >
                        <a id="back-from-page" href="{{ route('admin.region.creat') }}" > Ստեղծել նորը</a>
                    </button>
                </div>
                <div >
                    ...
                    @foreach($regions as $region)
                        ...
                        <div class="adminPosts">
                            <a data-v-767ef7eb="" tabindex="0" href="{{ route('admin.region.show',$region->id) }}"
                               class="Results-card">

                                <ul class="list-group list-group-horizontal-sm">

                                    <li class="list-group-item big-li">{{  $region->title }}</li>
