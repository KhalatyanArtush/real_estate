            ...
            <div class="container-fluid">
                <div class="container" style="column-count: 2;">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <h2>{{__('titles.type')}}</h2>

                    </div>
                    <button  class="btn btn-primary" style="width: 135px;" >
                        <a id="back-from-page" href="{{ route('admin.type.creat') }}" >{{__('buttons.Sign')}}</a>
                    </button>
                </div>
                <div>
                    ...
                    @foreach($types as $type)
                        ...
                        <div class="adminPosts">
                            <a data-v-767ef7eb="" tabindex="0" href="{{ route('admin.type.show',$type->id) }}"
                               class="Results-card">

                                <ul class="list-group list-group-horizontal-sm">

                                    <li class="list-group-item big-li">{{  $type->title }}</li>
