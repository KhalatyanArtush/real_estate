            ...
            <div class="container-fluid">
                <div class="container" style="column-count: 2;">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <h2>Գործողության տեսակը</h2>

                    </div>
                    <button class="btn btn-primary" style="width: 135px;">
                        <a id="back-from-page" href="{{ route('admin.buyRent.creat') }}"> Ստեղծել նորը</a>
                    </button>
                </div>
                <div>
                    ...
                    @foreach($buyRents as $buyRent)
                        ...
                        <div class="adminPosts">
                            <a data-v-767ef7eb="" tabindex="0" href="{{ route('admin.buyRent.show',$buyRent->id) }}"
                               class="Results-card">

                                <ul class="list-group list-group-horizontal-sm">

                                    <li class="list-group-item big-li">{{  $buyRent->title }}</li>
